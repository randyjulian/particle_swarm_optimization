## this section need to be run 10 times by changing the names of the output files at the end from 1-10
...
joblib.dump([sphere_avg,sphere_max,sphere_50,sphere_pos],"convergence pickle files/sphere_all_newseed10.pkl")

rastrigin_avg,rastrigin_max,rastrigin_50, rastrigin_pos=matrix1245(rastrigin_problem,False)
joblib.dump([rastrigin_avg,rastrigin_max,rastrigin_50, rastrigin_pos],"convergence pickle files/rastrigin_all_newseed10.pkl")

griewank_avg,griewank_max,griewank_50,griewank_pos=matrix1245(griewank_problem,False)
joblib.dump([griewank_avg,griewank_max,griewank_50,griewank_pos],"convergence pickle files/griewank_all_newseed10.pkl")

schaffer_avg,schaffer_max,schaffer_50,schaffer_pos=matrix1245(schaffer_problem,False)
joblib.dump([schaffer_avg,schaffer_max,schaffer_50,schaffer_pos],"convergence pickle files/schaffer_all_newseed10.pkl")

rosen_avg,rosen_max,rosen_50,rosen_pos=matrix1245(rosenbrock_problem,True)
joblib.dump([rosen_avg,rosen_max,rosen_50,rosen_pos],"convergence pickle files/rosen_all_newseed10.pkl")